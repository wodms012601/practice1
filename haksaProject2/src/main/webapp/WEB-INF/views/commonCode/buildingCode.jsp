        ...
        <script>
            $(document).ready(function() {
                $("#keyword").keyup(function() {
                    ...
                    $("#buildingTable > tbody").children().hide();
                    if(selectBox == "code"){
                        var temp = $("#buildingTable > tbody > tr").find("td:nth-child(1):contains('" + word + "')");
                        
                    }else if(selectBox == "name"){
						var temp = $("#buildingTable > tbody > tr").find("td:nth-child(2):contains('" + word + "')");    
